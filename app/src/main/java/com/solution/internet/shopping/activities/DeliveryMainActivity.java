 ...
 */
public class DeliveryMainActivity extends BaseActivity implements View.OnClickListener, HandleRetrofitResp
{
    @Override
...
//            addContentFragment(ReservationsFragments.init(intent.getStringExtra(DataEnum.extraReservationID.name())), true);
    ...
    {
        return R.layout.delivery_main_activity;
    }
...
//        adjustMenuItemFont();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener()
        {
            ...
            {//open correct view when clicked
                ...
                {
                    addContentFragment(new DeliveryHomeFragment(), true);
                ...
                {
                    addContentFragment(new DeliveryInvoices(), true);
