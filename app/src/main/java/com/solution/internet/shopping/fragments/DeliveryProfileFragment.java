...
public class DeliveryProfileFragment extends BaseFragment implements HandleRetrofitResp {
    //region fields
    ...
    @BindView(R.id.tvUserProfileWallet)
    TextView tvUserProfileWallet;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.delivery_profile_fragment, container, false);
...
//        appHeader.setRight(0, 0, 0);
    ...
    public static DeliveryProfileFragment init() {
        return new DeliveryProfileFragment();
    }
