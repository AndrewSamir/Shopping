...
public class AdapterCustomerInvoice extends RecyclerView.Adapter<AdapterCustomerInvoice.MyViewHolder> implements HandleRetrofitRespAdapter
{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        {
            ((BaseActivity) activity).addContentFragment(InvoiceDetails.init(adapterList.get(getAdapterPosition()).getCrId()), true);
        }
    }

    public AdapterCustomerInvoice(List<ModelInvoice> adapterList, Activity activity)
    {
